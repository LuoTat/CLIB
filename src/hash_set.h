...
#define HASHSET_IMPL(NAME, TYPE, SCOPE, Hash_Function, Equals_Function)                                                                                                                                                 \
    ...
    {                                                                                                                                                                                                                   \
        ...
        int                  NewCapacity;                                                                                                                                                                               \
        int                  NewThreshold;                                                                                                                                                                              \
        /* If the previous array capacity is zero */                                                                                                                                                                    \
        if (unlikely(OldCapacity == 0))                                                                                                                                                                                 \
        {                                                                                                                                                                                                               \
            NewCapacity  = DEFAULT_HASHSET_INITIAL_CAPACITY;                                                                                                                                                            \
        ...
        {                                                                                                                                                                                                               \
            ...
            if (unlikely(OldCapacity >= MAXIMUM_HASHSET_CAPACITY))                                                                                                                                                      \
            {                                                                                                                                                                                                           \
        ...
        /* To determine whether the lower 5th bit of the hash value is 0, simply AND the hash value with the hash table length. If it is 0, it means the lower 5th bit is 0; if not, it means the lower 5th bit is 1 */ \
                                                                                                                                                                                                                        \
        if (unlikely(OldTab == NULL)) return Success;                                  /* If the old hash table is NULL */                                                                                              \
        for (int i = 0; i < OldCapacity; ++i)                                          /* Traverse the old hash table */                                                                                                \
        {                                                                                                                                                                                                               \
            HashSetNode_##NAME* Temp;                                                                                                                                                                                   \
            if ((Temp = OldTab[i]) == NULL) continue;                                  /* If OldTab[i] is NULL */                                                                                                       \
    ...
    {                                                                                                                                                                                                                   \
        ...
        LocatedNode = &HashSet->Table[(Capacity - 1) & HashCode];                                                                                                                                                       \
        while (*LocatedNode)                                                                                                                                                                                            \
        {                                                                                                                                                                                                               \
    ...
    {                                                                                                                                                                                                                   \
        ...
        int                  HashCode;                                                                                                                                                                                  \
        if (HashSet->Size > 0 && *(Prev = &HashSet->Table[(HashSet->Capacity - 1) & (HashCode = HashSet_##NAME##_HashCode(Key))]))                                                                                      \
        {                                                                                                                                                                                                               \
            do {                                                                                                                                                                                                        \
                Curr = *Prev;                                                                                                                                                                                           \
    ...
    {                                                                                                                                                                                                                   \
        HashSetNode_##NAME** LocatedNode;                                                                                                                                                                               \
        int                  HashCode;                                                                                                                                                                                  \
        if (HashSet->Size > 0 && *(LocatedNode = &HashSet->Table[(HashSet->Capacity - 1) & (HashCode = HashSet_##NAME##_HashCode(Key))]))                                                                               \
        {                                                                                                                                                                                                               \
            do {                                                                                                                                                                                                        \
