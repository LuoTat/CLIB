...
#define _LINKEDLIST_PROTOTYPES(NAME, TYPE)                                                                                      \
    ...
    extern CODE LinkedList_##NAME##_IndexOf(const LinkedList_##NAME* const LinkedList, const TYPE Data, int* const Result);     \
    extern CODE LinkedList_##NAME##_LastIndexOf(const LinkedList_##NAME* const LinkedList, const TYPE Data, int* const Result); \
...
#define _LINKEDLIST_IMPL(NAME, TYPE, SCOPE, Equals_Function)                                                                                                       \
    ...
    SCOPE CODE LinkedList_##NAME##_IndexOf(const LinkedList_##NAME* const LinkedList, const TYPE Data, int* const Result)                                          \
    {                                                                                                                                                              \
        int                    index = 0;                                                                                                                          \
        LinkedListNode_##NAME* x;                                                                                                                                  \
        for (x = LinkedList->First; x != NULL; x = x->Next)                                                                                                        \
        {                                                                                                                                                          \
            if (Equals_Function(Data, x->Data))                                                                                                                    \
            {                                                                                                                                                      \
                *Result = index;                                                                                                                                   \
                return Success;                                                                                                                                    \
            }                                                                                                                                                      \
    ...
    SCOPE CODE LinkedList_##NAME##_LastIndexOf(const LinkedList_##NAME* const LinkedList, const TYPE Data, int* const Result)                                      \
    {                                                                                                                                                              \
    ...
    SCOPE bool LinkedList_##NAME##_Contains(const LinkedList_##NAME* const LinkedList, const TYPE Data)                                                            \
    {                                                                                                                                                              \
        int index;                                                                                                                                                 \
        return Success == LinkedList_##NAME##_IndexOf(LinkedList, Data, &index);                                                                                   \
    }                                                                                                                                                              \
...
#define LinkedList_IndexOf(NAME, LinkedList, Data, Result)      LinkedList_##NAME##_IndexOf((LinkedList), (Data), (Result))
#define LinkedList_LastIndexOf(NAME, LinkedList, Data, Result)  LinkedList_##NAME##_LastIndexOf((LinkedList), (Data), (Result))
#define LinkedList_Contains(NAME, LinkedList, Data)             LinkedList_##NAME##_Contains((LinkedList), (Data))
