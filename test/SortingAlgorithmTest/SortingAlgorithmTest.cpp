...
#define Mode                                     3
#define PRINT                                    0
#define SortCounter                              10000
#define RandomSend                               (unsigned)time(NULL)

#define InsertionSort_Test                       1
#define BinaryInsertionSort_Test                 1
#define ShellInsertionSort_Hibbard_Test          1
#define ShellInsertionSort_Sedgewick_Test        1
#define BubbleSort_Test                          1
#define BubbleSort_Fast_Test                     1
#define QuickSort_LTT_glibc_Test                 1
#define QuickSort_LTT_libstdcpp_Test             1
#define QuickSort_glibc_Test                     1
#define SimpleSelectionSort_Test                 1
#define HeapSort_Test                            1
#define MergeSort_Recursion_Test                 1
#define MergeSort_Iterative_Test                 1
#define MergeSort_Inplace_Iterative_Test         1
#define MergeSort_Inplace_Iterative_For_Int_Test 1
#define RadixSort_LSD_Test                       1
#define RadixSort_MSD_Test                       1
#define BucketSort_Test                          1
#define CountingSort_Test                        1
#define PigeonholeSort_Test                      1
#define BigoSort_Test                            1
